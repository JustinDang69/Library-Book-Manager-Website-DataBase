<?php
// sort_asc.php — list products in the chosen category by productName ASC (A→Z)
require_once('database.php');



// Read category_id from URL; default to 1 if missing/invalid
...
// Get the selected category (for heading)
...
// Get all categories (simple nav if you want to click around)
...
// Get products in this category, sorted by name ASC
$qProducts = 'SELECT * FROM products WHERE categoryID = :category_id ORDER BY productName ASC';
...
<head>
  <meta charset="utf-8">
  <title>Sort Ascending — <?php echo htmlspecialchars($category_name); ?></title>
